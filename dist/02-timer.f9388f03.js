...
(0, _notiflixReportAio.Report).info("\uD83D\uDC4B Greeting, my Friend!", "Please, choose a date and click on start", "Okay");
(0, _flatpickrDefault.default)(calendar, {
    enableTime: true,
    time_24hr: true,
    defaultDate: new Date(),
    minuteIncrement: 1,
    onClose (selectedDates) {
        if (selectedDates[0].getTime() < Date.now()) (0, _notiflixReportAio.Report).failure("\uD83E\uDD7A Ooops...", "Please, choose a date in the future", "Okay");
        else {
            (0, _notiflixReportAio.Report).success("\uD83E\uDD70 Congratulations! Click on start!", "Try.", "Okay");
...
const timer = {
    ...
    start () {
        intervalId = setInterval(()=>{
            ...
            if (delta <= 0) {
                this.stop();
                (0, _notiflixReportAio.Report).info("\uD83D\uDC4F Congratulation! Timer stopped!", "Please, choose a date and click on start", "Okay");
                return;
            }
...
},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix/build/notiflix-report-aio":"hNopu"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"eVN6V":[function() {},{}],"hNopu":[function(require,module,exports) {
var global = arguments[3];
/*
